...
tf.app.flags.DEFINE_integer(
    'num_classes', 21,#21
     'Number of classes to use in the crnn_dataset.')
tf.app.flags.DEFINE_integer(
    'batch_size', 1, 'The number of samples in each batch.')
tf.app.flags.DEFINE_integer(
    'max_num_batches', None,#Aimee None
    'Max number of batches to evaluate by default use all.')
tf.app.flags.DEFINE_string(
    'master', '', 'The address of the TensorFlow master to use.')
tf.app.flags.DEFINE_string(
    'checkpoint_path', './ssd_logs/model.ckpt-1000',#Aimee '/crnn_tmp/tfmodel/',
    'The directory where the model was written to or an absolute path to a '
    'checkpoint file.')
tf.app.flags.DEFINE_string(
    'eval_dir', './ssd_logs/', #Aimee '/tmp/tfmodel/',
    'Directory where the results are saved to.')
tf.app.flags.DEFINE_integer(
    'num_preprocessing_threads', 1,#Aimee 4
    'The number of threads used to create the batches.')
tf.app.flags.DEFINE_string(
    'dataset_name', 'pascalvoc_2007', 'The name of the dataset to load.')
tf.app.flags.DEFINE_string(
    'dataset_split_name', 'ssd_test', 'The name of the train/ssd_test split.')
tf.app.flags.DEFINE_string(
    'dataset_dir', "H:\programingProject\Python\SSD-Tensorflow-master\\ssd_tfrecords",#Aimee None,
...
tf.app.flags.DEFINE_float(
    'gpu_memory_fraction', 0.95,#Aimee 0.04
