    ...
    try:
        ...
        if all_tensors:
            ...
            for key in var_to_shape_map:
                ...
                print("size", (reader.get_tensor(key)).size)
                print("ndim", (reader.get_tensor(key)).ndim)
...
file_name = './ssd_logs/model.ckpt-200'
tensor_name=None
all_tensors = True
print_tensors_in_checkpoint_file(file_name, tensor_name,
                                 all_tensors)
