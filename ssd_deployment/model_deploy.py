...
# TODO(sguada) describe the high-level components of model ssd_deployment.
# E.g. "each model ssd_deployment is composed of several parts: a DeploymentConfig,
# which captures A, B and C, an input_fn which loads ssd_data.. etc
...
Usage:
    ...
    with tf.device(config.inputs_device()):
        ...
        inputs_queue = slim.ssd_data.prefetch_queue((images, labels))
...
# Namedtuple used to represent a clone during ssd_deployment.
...
def create_clones(config, model_fn, args=None, kwargs=None):
    ...
    The ssd_deployment options are specified by the config object and support
    ...
    If `config` specifies ssd_deployment on multiple replicas then the default
